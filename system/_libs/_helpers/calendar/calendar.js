...
var monthArrayMed = new Array('Jan', 'Fev', 'Mar', 'Avr', 'Mai', 'Jui', 'Jui', 'Aou', 'Sept', 'Oct', 'Nov', 'Dec');
...
function refreshDatePicker(dateFieldName, year, month, day)
{
  ...
  html += "<button class='dpTodayButton' onClick='refreshDatePicker(\"" + dateFieldName + "\");'>Mois actuel</button> ";
